...
- **Regulatory Rules**: Solicitors regulated by the **Solicitors Regulation Authority (SRA)** and barristers regulated by the **Bar Standards Board (BSB)** must comply with applicable professional conduct rules (including the SRA Code of Conduct and the BSB Handbook) when using AI tools
- **Client Disclosure**: Consider whether professional ethics rules require disclosing AI tool use to clients
- **Guidance**: Follow the Law Society of England and Wales and the Bar Council guidance on responsible use of AI in legal practice
...
1. Checking the official source (legislation.gov.uk — maintained by The National Archives)
...
5. Considering how post-Brexit changes, retained EU law, and recent legal developments may affect the matter

## Data Authority and Limitations

### Source Authority

This Tool aggregates data from official UK legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **legislation.gov.uk** | Authoritative | Statute text, statutory instruments (primary reference) |
| **The National Archives** | Authoritative | Historical versions, commencement orders |
| **BAILII / court websites** | Authoritative for case law | Judgments, decisions |
...
- Westlaw UK, LexisNexis, Practical Law, Halsbury's Laws of England
...
- UK law changes continuously through Acts of Parliament, statutory instruments, and court decisions
- **Last-updated timestamps** in tool responses indicate data age, but should be treated as unreliable
- Post-Brexit retained EU law and the Retained EU Law (Revocation and Reform) Act 2023 add further complexity to determining which law is currently in force

### Staleness Warnings

The Tool includes staleness warnings when data is >30 days old. **These warnings are not exhaustive**:

- Even "fresh" data may be outdated if recent amendments were published in the London, Edinburgh, or Belfast Gazettes
...
- A provision marked "in force" may have been:
  ...
  - Subject to transitional or savings provisions affecting its applicability
...
1. **Complete case law** — Coverage of Supreme Court, Court of Appeal, High Court, and devolved court decisions is limited; do not rely solely on this for case law research
...
5. **Full legislative history** — Limited coverage of Hansard, explanatory notes, and Law Commission reports
6. **Devolved legislation** — Scottish Parliament Acts, Senedd Cymru legislation, and Northern Ireland Assembly Acts may have incomplete coverage
7. **Retained EU law** — The complex post-Brexit status of retained EU law may not be fully reflected
...
- **Devolution Blind Spots**: Cannot fully assess whether English, Scottish, Welsh, or Northern Irish law applies to a given matter
...
- This includes but is not limited to:
  ...
  - Regulatory sanctions from the SRA, BSB, or other regulatory bodies
  - Reputational damage
...
This Tool uses AI/algorithmic methods for search and ranking. Although the UK has not adopted the EU AI Act, equivalent transparency principles apply:
...
- **Professional Rules**: Comply with SRA, BSB, and other applicable regulatory requirements regarding AI tool use
...
- Stay current with legal developments, including post-Brexit changes
...
2. **Official Verification**: Cross-check ALL results with official sources (legislation.gov.uk)
3. **Commercial Databases**: Use professional legal databases (Westlaw UK, LexisNexis) for authoritative, annotated versions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/UK-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/UK-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (legislation.gov.uk)
...
- **COMPLY** with SRA and BSB professional ethics rules regarding AI tool use and client confidentiality
