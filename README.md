...
|---|---|---|---|---|---|---|---|
| [www.legislation.gov.uk](https://www.legislation.gov.uk/) | https://www.legislation.gov.uk/ | [Terms](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/) | Open Government Licence v3.0 (OGL) | Yes | Yes | Yes | Crown and database-right material on legislation.gov.uk is available under OGL v3.0 except where otherwise stated; attribution required. The site notes specific exceptions (e.g. some pre-1988 derived content). |
