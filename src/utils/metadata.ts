/**
 * Response metadata for UK Law MCP tool responses.
 */
...
export function generateResponseMetadata(
  ...
  return {
    ...
    disclaimer:
      'This data is derived from legislation.gov.uk open data. ' +
      'Verify against official publications when legal certainty is required.',
    source_authority: 'The National Archives (legislation.gov.uk)',
  };
}
